---
title: "Flights Data Visulization"
...
Lets visualize the flight routes data from openflights.org. For this I used the airports.dat and routes.dat, one contains information of airports around the world and the other contains flights data of Jan 2012. This was done as an assignment for my big data analytics course in HKU.

Due to limited computation power only flight routes from 3 airlines are visualized, but it can be scaled up easily. The airlines im visualizing are Cathay, Emirates and Delta, with the flights from Cathay shown in green, Emirates in red and Delta in blue.
